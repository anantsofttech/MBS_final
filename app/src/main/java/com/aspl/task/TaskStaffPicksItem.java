...
public class TaskStaffPicksItem extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskStaffPicksEvent homeItemEvent;
    //Zipmodel model;
    public TaskStaffPicksItem(TaskStaffPicksEvent homeItemEvent) {
        this.homeItemEvent = homeItemEvent;
    }


    public interface TaskStaffPicksEvent {
        void onGetStaffPicksResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (homeItemEvent != null) {
            homeItemEvent.onGetStaffPicksResult(HomeItemList);
        }
    }
}
