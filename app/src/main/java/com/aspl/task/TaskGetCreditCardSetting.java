...
public class TaskGetCreditCardSetting extends AsyncTask<String, Void, String> {
    ...
    public TaskGetCreditCardSetting(TaskGetCreditCardSettingEvent myTaskGetCreditCardSettingEvent){
    ...
    protected void onPostExecute(String s) {
        ...
        if (myTaskGetCreditCardSettingEvent!=null && creditCartSetting != null)
