...
public class TaskHomePageItem extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskHomeItemEvent homeItemEvent;
    //Zipmodel model;
    public TaskHomePageItem(TaskHomeItemEvent homeItemEvent) {
        this.homeItemEvent = homeItemEvent;
    }


    public interface TaskHomeItemEvent {
        void onGetHomeItemResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (homeItemEvent != null) {
            homeItemEvent.onGetHomeItemResult(HomeItemList);
        }
    }
}
