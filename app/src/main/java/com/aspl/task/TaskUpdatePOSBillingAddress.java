...
public class TaskUpdatePOSBillingAddress extends AsyncTask<String, Void, String> {

    //ShippingData shippingData;
    UpdatePOSBillingAddress updatePOSBillingAddress;

    UpdatePOSBillingAddressEvent myUpdatePOSBillingAddressEvent;

    public interface UpdatePOSBillingAddressEvent{
        void onPOSBillingAddressResult(UpdatePOSBillingAddress updatePOSBillingAddress);
    }

    public TaskUpdatePOSBillingAddress(UpdatePOSBillingAddressEvent myUpdatePOSBillingAddressEvent){
        this.myUpdatePOSBillingAddressEvent = myUpdatePOSBillingAddressEvent;
    }
