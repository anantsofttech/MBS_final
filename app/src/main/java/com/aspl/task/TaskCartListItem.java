...
public class TaskCartListItem extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskCartListEvent CartListEvent;
    //Zipmodel model;
    public TaskCartListItem(TaskCartListEvent CartListEvent) {
        this.CartListEvent = CartListEvent;
    }

    public interface TaskCartListEvent {
        void onGetCartListResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (CartListEvent != null) {
            CartListEvent.onGetCartListResult(HomeItemList);
        }
    }
}
