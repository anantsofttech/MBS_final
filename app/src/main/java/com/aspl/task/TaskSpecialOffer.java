...
public class TaskSpecialOffer extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskSpecialOfferEvent homeItemEvent;
    //Zipmodel model;
    public TaskSpecialOffer(TaskSpecialOfferEvent homeItemEvent) {
        this.homeItemEvent = homeItemEvent;
    }


    public interface TaskSpecialOfferEvent {
        void onGetSpecialOfferResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (homeItemEvent != null) {
            homeItemEvent.onGetSpecialOfferResult(HomeItemList);
        }
    }
}
