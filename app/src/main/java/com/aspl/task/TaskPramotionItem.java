...
public class TaskPramotionItem extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskPramotionItemEvent homeItemEvent;
    //Zipmodel model;
    public TaskPramotionItem(TaskPramotionItemEvent homeItemEvent) {
        this.homeItemEvent = homeItemEvent;
    }


    public interface TaskPramotionItemEvent {
        void onGetPramotionItemResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (homeItemEvent != null) {
            homeItemEvent.onGetPramotionItemResult(HomeItemList);
        }
    }
}
