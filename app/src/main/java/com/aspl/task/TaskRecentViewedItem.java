...
public class TaskRecentViewedItem extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskRecentViewedEvent RecentViewedEvent;
    //Zipmodel model;
    public TaskRecentViewedItem(TaskRecentViewedEvent homeItemEvent) {
        this.RecentViewedEvent = homeItemEvent;
    }


    public interface TaskRecentViewedEvent {
        void onGetRecentViewedResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (RecentViewedEvent != null) {
            RecentViewedEvent.onGetRecentViewedResult(HomeItemList);
        }
    }
}
