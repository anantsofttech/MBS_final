...
public class TaskWishListItem extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskWishListEvent WishListEvent;
    //Zipmodel model;
    public TaskWishListItem(TaskWishListEvent WishListEvent) {
        this.WishListEvent = WishListEvent;
    }


    public interface TaskWishListEvent {
        void onGetWishListResult(List<HomeItemModel> HomeItemList);
    }
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (WishListEvent != null) {
            WishListEvent.onGetWishListResult(HomeItemList);
        }
    }
}
