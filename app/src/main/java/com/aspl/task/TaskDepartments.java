...
public class TaskDepartments extends AsyncTask<String, Void, String> {

    private List<JackDepartmentModel> DepartmentList;

    TaskDepartmentEvent homeItemEvent;
    //Zipmodel model;
    public TaskDepartments(TaskDepartmentEvent homeItemEvent) {
        this.homeItemEvent = homeItemEvent;
    }

    public interface TaskDepartmentEvent {
        void onGetDepartmentResult(List<JackDepartmentModel> DepartmentList);
    }
...
*/
                ...
                DepartmentList=objectMapper.readValue(response, collectionType);
    ...
    protected void onPostExecute(String s) {
        ...
        if (homeItemEvent != null) {
            homeItemEvent.onGetDepartmentResult(DepartmentList);
        }
    }
}
