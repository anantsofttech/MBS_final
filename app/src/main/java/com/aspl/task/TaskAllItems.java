...
public class TaskAllItems extends AsyncTask<String, Void, String> {

    private List<HomeItemModel> HomeItemList;

    TaskAllItemsEvent homeItemEvent;
    //Zipmodel model;
    public TaskAllItems(TaskAllItemsEvent homeItemEvent) {
        this.homeItemEvent = homeItemEvent;
    }


    public interface TaskAllItemsEvent {
        void onGetAllItemsResult(List<HomeItemModel> HomeItemList);
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        Log.i("web service--Cart", "request url 100: " + strings[0]);
        int count = 0;
        boolean retry = false;
...
*/
    ...
    protected void onPostExecute(String s) {
        ...
        if (homeItemEvent != null) {
            homeItemEvent.onGetAllItemsResult(HomeItemList);
        }
    }
}
