...
public class FilterSelectedItemAdapter_dup extends RecyclerView.Adapter<FilterSelectedItemAdapter_dup.FilterSelectedItemViewHolder> {
...
*/
    ...
    public FilterSelectedItemAdapter_dup(List<FilterSelectedItems> liFilterSelectedItems){
        this.liFilterSelectedItems = liFilterSelectedItems;
    }

    public FilterSelectedItemAdapter_dup(FilterSelectedItems filterSelectedItems){
