...
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
    ...
    public class ItemDescModel {
        ...
        @JsonProperty("lstInventory")
        private List<lstInventoryModel> lstInventorylist = null;
        ...
        public List<com.aspl.mbsmodel.lstInventoryModel> getLstInventoryModel() {
            return lstInventorylist;
        }

        public void setLstInventoryModel(List<com.aspl.mbsmodel.lstInventoryModel> lstInventoryModel) {
            this.lstInventorylist = lstInventoryModel;
        }
    }
