...
public class LstGiftCard_cart {
    ...
    public Boolean getTotalSavingDisplay() {
        return isTotalSavingDisplay;
    }

    public void setTotalSavingDisplay(Boolean totalSavingDisplay) {
        isTotalSavingDisplay = totalSavingDisplay;
    }
