...
public class HomeItemModel {
    ...
    @JsonProperty("descAll")
    private String descAll;
    @JsonProperty("IsHomeQuickAddCart")
    private String IsHomeQuickAddCart;
    ...
    private Integer handlingSurcharge;
    ...
    @JsonProperty("HandlingSurcharge")
    public Integer getHandlingSurcharge() {
        return handlingSurcharge;
    }

    @JsonProperty("HandlingSurcharge")
    public void setHandlingSurcharge(Integer handlingSurcharge) {
    ...
    public String getIsHomeQuickAddCart() {
        return IsHomeQuickAddCart;
    }

    public void setIsHomeQuickAddCart(String isHomeQuickAddCart) {
        IsHomeQuickAddCart = isHomeQuickAddCart;
    }
